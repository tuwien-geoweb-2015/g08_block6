...
var wmsLayer = new ol.layer.Image({
  source: new ol.source.ImageWMS({
    ...
    params: {'LAYERS': 'g08_2015:normalized','g08_2015:comments'}
  }),
  opacity: 0.6
});
...
olMap = new ol.Map({
  ...
  view: new ol.View({
    center: ol.proj.fromLonLat([-96.69, 37.59]), // Wert für Österreich sinnvoll adaptieren
    zoom: 5,
    maxZoom: 18
  })
});
...
olMap.on('singleclick', function(evt) {
  ...
  var xml = new ol.format.WFS().writeTransaction([feature], null, null, {
    featureType: 'comments', featureNS: 'http://g08/2015',
